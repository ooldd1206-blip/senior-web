...
export default function ChatRoomPage() {
  ...
  // ⭐ 讀取來源（MATCH / ACTIVITY_CARD / ACTIVITY_TRIP），預設 MATCH
  const rawSource = search.get("source");
  const chatSource: ChatSource =
    rawSource === "ACTIVITY_CARD" ||
    rawSource === "ACTIVITY_TRIP" ||
    rawSource === "MATCH"
      ? (rawSource as ChatSource)
      : "MATCH";
  ...
  const [activityInfo, setActivityInfo] = useState<ActivityPreview | null>(
    null
  );
